...
class MemorySystem {
   public:
    ...
    bool AddTransaction(uint64_t hex_addr, uint64_t start, bool is_write);
    bool AddTransaction(uint64_t hex_addr, uint64_t start, uint64_t requester, bool is_write);
